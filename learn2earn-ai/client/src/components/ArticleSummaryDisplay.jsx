export default function ArticleSummaryDisplay({ summary }) {
  ...
  return (
    <div className="bg-gray-800 text-white p-4 sm:p-6 md:p-8 rounded-xl space-y-4 sm:space-y-6">
      {/* Title */}
      ...
      {Array.isArray(KeyPoints) && KeyPoints.length > 0 && (
        <div>
          <h3 className="text-base sm:text-lg font-semibold text-cyan-400 mt-4">🔑 Key Points</h3>
      ...
      {/* Source */}
      {Source && (
        <div className="text-xs sm:text-sm text-gray-400 mt-4 break-all">
